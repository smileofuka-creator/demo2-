...
const Home = () => {
  return (
    <div className="flex gap-[24] bg-white border w-screen h-screen">
      <Button title="All" isActive={true}></Button>
      <Button title="Active" isChecked={true}></Button>
      <Button title="Compoleted"></Button>
    </div>
  );
};
export default Home;
